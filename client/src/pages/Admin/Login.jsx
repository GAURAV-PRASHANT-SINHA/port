    ...
    <>
      <section className=" bg-gray-100 overflow-x-hidden">
        <div className="relative container px-4 mx-auto">
          <div className="absolute inset-0 bg-blue-200  -ml-4" />
          <div className="relative flex  bg-white">
            ...
            <div
              ...
              <dotlottie-player src="https://lottie.host/48de3ab5-a841-4e8e-87ed-cddbce2ab5b8/CEaGfqnJGy.json" background="transparent" speed="1"  loop autoplay></dotlottie-player>
